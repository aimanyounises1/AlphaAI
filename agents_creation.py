...
async def create_agents():
    ...
    agents = {
        ...
        "Retriever_Agent": (ChainlitAssistantAgent, {
            "llm_config": local_llm_config,
        ...
        "Tester_Agent": (ChainlitAssistantAgent, {
            "llm_config": local_llm_config,
        ...
        "Code_Reviewer_Agent": (ChainlitAssistantAgent, {
            "llm_config": local_llm_config,
...
async def run_conversation(initial_message: str):
    ...
    user_proxy = next((agent for agent in agents if isinstance(agent, EnhancedRetrieveUserProxyAgent)), None)

    if user_proxy is None:
        logger.error("User Proxy Agent not found")
        return []
